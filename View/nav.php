...
$nav = '<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">CSynapse</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="#">
                                ...
                                <div>Server Maintenance Scheduled in 2 days</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#">
                                ...
                                <div>Message Recieved by Admin</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                    ...
                    <ul class="dropdown-menu dropdown-tasks">
                        <li>
                             <a href="#">
                                 <div>
                                     <p>
                                        <strong>Weather Patterns: Texas</strong>
                        ...
                        <li>
                            <a class="text-center" href="/index.php">
                                <strong>See All Training Progress</strong>
                                <i class="fa fa-angle-right"></i>
                            </a>
                        </li>
                    </ul>
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    ...
                                    <span class="pull-right text-muted small">  4 Hours ago</span>
                                </div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    ...
                                    <span class="pull-right text-muted small"> 6 Hours Ago </span>
                                </div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#">
                                <div>
                                    ...
                                    <span class="pull-right text-muted small"> 7 Hours Ago</span>
                                </div>
                            </a>
                        </li>
                        <li class="divider"></li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="create.php"><i class="fa fa-wrench fa-fw"></i> New CSynapse </a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> My CSynapses<span class="fa arrow"></span></a>
